...
frameNum = 0
beforeFaceNum = 0
cmd = "python ./facepp-python-sdk/cam4_del.py"
...
while(True):
    ...
    flug = os.path.exists("./cam4/" +str(frameNum+15) +".jpg")

    if flug:
        print "file exists"
    
        #入力画像の読み込み
        img = cv2.imread("./cam4/" +str(frameNum) +".jpg")
        if hasattr(img, "shape"):
            if(img.data):
                ...
                #print "faceNum = " + str(len(faces))
                    ...
                    cmd = "python ./facepp-python-sdk/cam4.py " +str(frameNum) +".jpg"
