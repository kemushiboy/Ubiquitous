...
frameNum = 0
beforeFaceNum = 0
cmd = "python ./facepp-python-sdk/cam2_del.py"
subprocess.call(cmd.strip().split(" "))


while(True):
        
    flug = os.path.exists("./cam2/" +str(frameNum+15) +".jpg")

    if flug:
        print "file exists"
    
        #入力画像の読み込み
        img = cv2.imread("./cam2/" +str(frameNum) +".jpg")
        if hasattr(img, "shape"):
            if(img.data):
                ...
                #print "faceNum = " + str(len(faces))
                #if len(faces) > beforeFaceNum: 顔が増えていたらfacepp実行
                    #赤枠
                    ...
                    cmd = "python ./facepp-python-sdk/cam2.py " +str(frameNum) +".jpg"
