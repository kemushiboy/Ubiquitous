...
PERSONS = [('person', '/Users/Ishikawa/cam1/' + IMAGE_DIR)]
...
faceIDs = []
f = open("/Users/Ishikawa/cam1.csv",'ab')
...
#rst = api.faceset.create(faceset_name = 'cam1')
#print_result('create faceset', rst)
if len(faceIDs)>0:
    rst = api.faceset.add_face(faceset_name = 'cam1', face_id = faceIDs)
