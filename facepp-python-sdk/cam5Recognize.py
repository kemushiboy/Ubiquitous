...
# 步骤5：识别新图中的Face
    ...
    rst = api.recognition.search(key_face_id = faceIDs[0], faceset_name = 'cam5')
    ...
    csvf  = open("/Users/Ishikawa/cam5.csv",'r')
    ...
    msg = OSC.OSCMessage()
    msg.setAddress("/cam5recognize")
    if camSimilarity > 70:
        msg.append(frame)
    # msg.append(cam5Similarity)
    else:
        msg.append("0")
#   msg.append(cam5Similarity)
