...
API_KEY = '0ec93d28726cac32877db5e043158cbc'
API_SECRET = 'H8CQIrDBjI37kodes6sLWCOYNy_TdMuv'
...
#rst = api.faceset.create(faceset_name = 'cam9')
rst = api.faceset.remove_face(faceset_name = 'cam9', face_id = 'all')
