...
API_KEY = '863c687cee51e744fa460304e905cad3'
API_SECRET = '9OD300VPSJ2cO559GpyFDdYEOWTtw1Zz'
...
PERSONS = [('person', '/Users/Ishikawa/cam2/' + IMAGE_DIR)]
...
faceIDs = []
f = open("/Users/Ishikawa/cam2.csv",'ab')
...
#rst = api.faceset.create(faceset_name = 'cam2')
#print_result('create faceset', rst)
if len(faceIDs)>0:
    rst = api.faceset.add_face(faceset_name = 'cam2', face_id = faceIDs)
