...
API_KEY = '4c20e1e2393bde72d37d93c1172a1a19'
API_SECRET = 'NIDQkTHd7eBugOy9rISSIQPFVHkw-xuN'
...
# 步骤5：识别新图中的Face
    ...
    rst = api.train.search(faceset_name = 'cam6')
    #rst = api.train.search(faceset_name = 'cam2')
    #rst = api.train.search(faceset_name = 'cam3')
    print "training"
    
    rst = api.recognition.search(key_face_id = faceIDs[0], faceset_name = 'cam6')
    ...
    csvf  = open("/Users/Ishikawa/cam6.csv",'r')
    ...
    msg = OSC.OSCMessage()
    msg.setAddress("/cam6recognize")
    if camSimilarity > 70:
        msg.append(frame)
    #       msg.append(cam6Similarity)
