...
API_KEY = '0cc21a71aa34c09b07ddc93a563f2dd4'
API_SECRET = '79ELt_rnHNuPABfzrUh8QZBvSFPx9Udh'
...
# 步骤5：识别新图中的Face
    ...
    rst = api.train.search(faceset_name = 'cam8')
    #rst = api.train.search(faceset_name = 'cam2')
    #rst = api.train.search(faceset_name = 'cam3')
    print "training"
    
    rst = api.recognition.search(key_face_id = faceIDs[0], faceset_name = 'cam8')
    ...
    csvf  = open("/Users/Ishikawa/cam8.csv",'r')
    ...
    msg = OSC.OSCMessage()
    msg.setAddress("/cam8recognize")
    if camSimilarity > 70:
        msg.append(frame)
    #       msg.append(cam8Similarity)
    else:
        msg.append("0")
#    msg.append(cam8Similarity)
