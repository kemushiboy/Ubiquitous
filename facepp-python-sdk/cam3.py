...
API_KEY = '8300e2f2d4540404fe125380f14017e5'
API_SECRET = 'D_aqpUBCVzcPhBohu5DXN0iyB-KpU4cM'
...
PERSONS = [('person', '/Users/Ishikawa/cam3/' + IMAGE_DIR)]
...
faceIDs = []
f = open("/Users/Ishikawa/cam3.csv",'ab')
...
#rst = api.faceset.create(faceset_name = 'cam3')
#print_result('create faceset', rst)
if len(faceIDs)>0:
    rst = api.faceset.add_face(faceset_name = 'cam3', face_id = faceIDs)
