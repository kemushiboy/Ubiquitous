...
API_KEY = '46be03caef6168627c986ee810f1f436'
API_SECRET = 'rUxHmV2VwU2bjid9BuFb_Q0iHluG7AKO'
...
# 步骤5：识别新图中的Face
    ...
    rst = api.train.search(faceset_name = 'cam7')
    #rst = api.train.search(faceset_name = 'cam2')
    #rst = api.train.search(faceset_name = 'cam3')
    print "training"
    
    rst = api.recognition.search(key_face_id = faceIDs[0], faceset_name = 'cam7')
    ...
    csvf  = open("/Users/Ishikawa/cam7.csv",'r')
    ...
    msg = OSC.OSCMessage()
    msg.setAddress("/cam7recognize")
    if camSimilarity > 70:
        msg.append(frame)
    #    msg.append(cam7Similarity)
    else:
        msg.append("0")
#   msg.append(cam7Similarity)
