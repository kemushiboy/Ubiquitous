...
frameNum = 0
beforeFaceNum = 0
cmd = "python ./facepp-python-sdk/cam7_del.py"
subprocess.call(cmd.strip().split(" "))


while(True):
    flug = os.path.exists("./cam7/" +str(frameNum+15) +".jpg")
    
    if flug:
        print "file exists"
    
        #入力画像の読み込み
        img = cv2.imread("./cam7/" +str(frameNum) +".jpg")
        if hasattr(img, "shape"):
            if(img.data):
                ...
                #print "faceNum = " + str(len(faces))
                    ...
                    cmd = "python ./facepp-python-sdk/cam7.py " +str(frameNum) +".jpg"
